...
### modifying config.plist efi and shows error is my biggest fear btw no flushing nvram support also no support go ahead and look opencore documents and fix config.plist ill just do version update
Thanks for watching my fuckass README generated by copilot aka AI slop!
